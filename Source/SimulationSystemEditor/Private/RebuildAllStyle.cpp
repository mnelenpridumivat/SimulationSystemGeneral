...
TSharedPtr< FSlateStyleSet > FRebuildAllStyle::StyleInstance = nullptr;

void FRebuildAllStyle::Initialize()
{
...
void FRebuildAllStyle::Shutdown()
{
...
void FRebuildAllStyle::ReloadTextures()
{
...
const ISlateStyle& FRebuildAllStyle::Get()
{
	return *StyleInstance;
}

FName FRebuildAllStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("RebuildAllStyle"));
	return StyleSetName;
}
...
TSharedRef<FSlateStyleSet> FRebuildAllStyle::Create()
{
